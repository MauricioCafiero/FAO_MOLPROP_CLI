...
def main():
    ...
    print("## 1. Primary test — replicate-level mean HOMO-LUMO gap, all 6 conditions pooled\n")
    print("Kruskal-Wallis across all 6 conditions (unit = one replicate's mean gap, "
